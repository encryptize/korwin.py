...
def korwin_random():
    odp1 = random.choice(korwin1)
    odp2 = random.choice(korwin2)
    odp3 = random.choice(korwin3)
    odp4 = random.choice(korwin4)
    odp5 = random.choice(korwin5)
    odp6 = random.choice(korwin6)
    korwin = (odp1 + " " + odp2 + " " + odp3 + " " + odp4 + " " + odp5 + " " + odp6)
    return korwin
